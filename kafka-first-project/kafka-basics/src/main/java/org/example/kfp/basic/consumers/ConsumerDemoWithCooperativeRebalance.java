...
public class ConsumerDemoWithCooperativeRebalance {
    private static Logger LOG = LoggerFactory.getLogger(ConsumerDemoWithCooperativeRebalance.class);
     ...
     */
        ...
        properties.setProperty(KafkaConstants.PARTITION_ASSIGNMENT_STRATEGY, CooperativeStickyAssignor.class.getName());
